 ...
 * 
 * 1) preHandle() - 전 처리
 * 	Dispatcher Servlet -> Controller 사이에 요청/응답을 가로채서 수행
 * 
 * 2) postHandle() - 후 처리
 * 	Controller -> Dispatcher Servlet 사이에 요청/응답을 가로채서 수행
 * 
 * 3) afterCompletion() - foward된 뷰 완성 후
 * 	View Resolver -> Diapatcher Servlet 사이 수행
 * 
 */
...
//		log.info("---------- BoardTypeInterceptor 전처리 메서드 실행 ----------");
		...
		// 어떤 요청이 와도 header에 출력되는 게시판 메뉴를 DB에서 Apllication Scope에 세팅
